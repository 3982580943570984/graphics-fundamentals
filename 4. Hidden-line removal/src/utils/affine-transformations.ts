...
export class AffineTransformations {
  ...
  public static createXRotationMatrix(angle: number): THREE.Matrix4 {//{{{
  ...
  public static createYRotationMatrix(angle: number): THREE.Matrix4 {//{{{
    const cosTheta = Math.cos(angle);
    const sinTheta = Math.sin(angle);
  ...
  public static createZRotationMatrix(angle: number): THREE.Matrix4 {//{{{
    const cosTheta = Math.cos(angle);
    const sinTheta = Math.sin(angle);
